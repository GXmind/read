...
public class MainActivity extends Activity {
    ...
    private LinearLayout bottomNav(){LinearLayout nav=new LinearLayout(this);nav.setGravity(Gravity.CENTER);nav.setPadding(dp(8),dp(3),dp(8),dp(3));nav.setBackgroundColor(Color.WHITE);nav.setElevation(dp(12));LinearLayout.LayoutParams p=new LinearLayout.LayoutParams(0,-1,1);nav.addView(navItem("▣","书架",true),p);nav.addView(navItem("▤","本地",false),p);LinearLayout notes=navItem("✎","笔记",false);notes.setOnClickListener(v->openNotes());nav.addView(notes,p);LinearLayout mine=navItem("○","更新",false);mine.setOnClickListener(v->startActivity(new Intent(this,UpdateActivity.class)));nav.addView(mine,p);return nav;}
